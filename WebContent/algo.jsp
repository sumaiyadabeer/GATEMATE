...
<center>
<h3>SYLLABUS:-</h3>
<h4>Searching, sorting, hashing. Asymptotic worst case time and space complexity. Algorithm design techniques: greedy, dynamic programming and divide‐and‐conquer. Graph search, minimum spanning trees, shortest paths. </h4>
<br>

 <a href="algo1.html">introduction of algorithm</a>
 <br>
  <br>
  <a href="algo2.html">video lecture</a>
 <br>
 <br>
 <br>
 <br>
